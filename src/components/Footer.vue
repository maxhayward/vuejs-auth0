<template>
  <footer
    class="text-center bg-gray-900 text-white page-layout__footer"
    id="footer"
  >
    <div class="px-6 pt-6">
    ...
    <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.2)">
      © 2021 Copyright:
      <a class="text-whitehite" href="https://maxhayward.co.uk/">Max Hayward</a>
    </div>
  </footer>
</template>
